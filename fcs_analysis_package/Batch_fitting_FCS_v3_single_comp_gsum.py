...
set_kappa = 6.82                  # from calibration, A488
# set_kappa = 6.85                     # from calibration, A594
td_ref = ufloat(0.0382, 0.00015)     # from calibration (ms), A488 
...
temperature_lab = ufloat(20.0, 0.5)    # our labs temeprature (celsius)
...
path = "/Users/bab226/Documents/yale_research/iapp/fcs/fcs_analyzer_package/fcs_analysis_package/Data/BB_thermo_sds_iao_step_dilutions_01-28-22.sptw/"
for name in glob.glob(path + "sds_iao_dilution_01-28-22_00.dat"):

...
def triplet_diff3d(timelag, tau_diff, tau_trip, T, A0, Ginf, kappa):
    return (Ginf + A0 * 1/(1 - timelag) * 1/(1 + timelag/tau_diff) * 1/np.sqrt(1 + timelag/(tau_diff*(kappa**2))) * (1 - timelag + timelag * e**(-timelag/tau_trip)))

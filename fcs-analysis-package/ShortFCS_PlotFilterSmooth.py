...
t2, N2, errN2 = ReadData(path + name + '_N_2c_' + key + '.dat')
...
plt.legend()
print(np.mean(R1))
plt.savefig(path+name+'iapoe2_plot_rh_kinetics_'+ key+'.png', dpi = 300, bbox_inches='tight')
